//
//  MindValleyBoardCustomLayout.swift
//  MindValleyBoard
//
//  Created by Rahim Khalid on 30/05/2019.
...
protocol MindValleyBoardCustomLayoutDelegate: class {
    // 1. Method to ask the delegate for the height of the image
    func collectionView(_ collectionView:UICollectionView, heightForPhotoAtIndexPath indexPath:IndexPath) -> CGFloat
}

class MindValleyBoardCustomLayout: UICollectionViewLayout {
    //Pinterest Layout Delegate
    weak var delegate: MindValleyBoardCustomLayoutDelegate!
